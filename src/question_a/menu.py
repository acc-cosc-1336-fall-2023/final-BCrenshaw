...
def main_menu(matrix):
    ...
    while user_selection != exit_clause:
        ...
        if user_selection == '1':
            os.system('clear')
            qa.display_multiplication_table(matrix)
